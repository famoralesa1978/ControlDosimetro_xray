namespace ControlDosimetro.Herramientas
{
    partial class frmCambioFecha
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dtp_FechaDestino.Size = new System.Drawing.Size(64, 13);
			this.dtp_FechaDestino.TabIndex = 28;
			this.dtp_FechaDestino.Text = "Fecha inicio";
			// 
			// dtp_FechaInicio
			// 
			...
			this.lbl_FechaDestino.Size = new System.Drawing.Size(77, 13);
			this.lbl_FechaDestino.TabIndex = 24;
			this.lbl_FechaDestino.Text = "Fecha cambio:";
			// 
			// btn_Modificar
			// 
