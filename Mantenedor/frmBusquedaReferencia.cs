...
namespace ControlDosimetro
{
    public partial class frmBusquedaReferencia : Form
    {
        ...
        #region "Definicion variable"
                 ...
                 public frmBusquedaReferencia(Int64 intCodigo)
        {
            InitializeComponent();
        ...
        {
            ClaseComun.Listar_Estado(ref cbx_EstadoId, ref cbx_EstadoId);
        }
...
//            SqlCommand cmd = new SqlCommand();
            ...
            cmd.CommandText = "SELECT run,Razon_Social,Direccion,Id_Region,Id_Provincia,Id_Comuna,Telefono, Id_TipoFuente " +
                        " FROM tbl_cliente WHERE Id_cliente= " + lbl_Codigo.Text.ToString();
            DataSet dt;
            dt = Conectar.Listar(cmd);
        ...
        {
			frmReferenciaMant frm = new frmReferenciaMant(Convert.ToInt64(grdDatos.SelectedCells[0].Value.ToString()), lbl_Codigo.Text);
            frm.ShowDialog(this);
            Listar_Referencia();
        }
        #endregion
