...
{
    public partial class frmMantenedorUsuario02 : Form
    {
        ...
        public frmMantenedorUsuario02(Int64 intCodUsuario)
        {
            InitializeComponent();
            AsignarEvento();
        ...
        private void frmMantenedorUsuario02_Load(object sender, EventArgs e)
        {            
            CargarGrilla();
        }
        ...
        private void AsignarEvento()   //VALIDA RUT
        {
        ...
        private void CargarGrilla()
        {
            ...
            cmd.CommandText = "SELECT [Usuario],[Nombres] " +
