...
{
    public partial class frmOrdenTrabajoPorDocumento : Form
    {
        ...
        #region "Definicion variable"
            ...
            public frmOrdenTrabajoPorDocumento(int intId_Estado)
        {
            InitializeComponent();
	...
	//txt_RazonSocial.KeyPress += new KeyPressEventHandler(ClaseEvento.Avanzar_KeyPress);
            txt_NCliente.KeyDown += new KeyEventHandler(ClaseEvento.Numero_KeyDown);
            txt_NCliente.KeyPress += new KeyPressEventHandler(ClaseEvento.Numero_KeyPress);
        }
