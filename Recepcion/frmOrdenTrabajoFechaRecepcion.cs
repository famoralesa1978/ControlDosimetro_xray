...
{
    public partial class frmOrdenTrabajoFechaRecepcion : Form
    {
        ...
        #region "Definicion variable"
            ...
            public frmOrdenTrabajoFechaRecepcion(int intId_Estado)
        {
            InitializeComponent();
        ...
        #region "Llamada de carga"
		  ...
		  private void Listar_Grilla()
		  {
              ...
              String strFechaDesde = dtp_FechaDesde.Text.ToString();

              DataSet dt;
              cmd.CommandText = "[pa_OrdenTrabajoPorFechaRecepcion_sel] '" + strFechaDesde + "'";
              // pa_OrdenTrabajo_sel
