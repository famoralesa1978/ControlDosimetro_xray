...
{
	partial class frmAyudaPersonalPorCliente
	{
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.txt_ref_cliente.ReadOnly = true;
			...
			// txtSeccion
			// 
			this.txtSeccion.Location = new System.Drawing.Point(268, 44);
			this.txtSeccion.MaxLength = 60;
			this.txtSeccion.Name = "txtSeccion";
			this.txtSeccion.ReadOnly = true;
			this.txtSeccion.Size = new System.Drawing.Size(169, 20);
			this.txtSeccion.TabIndex = 36;
			this.txtSeccion.TabStop = false;
			// 
			// label4
			// 
			...
			this.Name = "frmAyudaPersonalPorCliente";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Busqueda Personal";
			this.Load += new System.EventHandler(this.frmAyudaPersonalPorCliente_Load);
		...
		public System.Windows.Forms.TextBox txt_ref_cliente;
