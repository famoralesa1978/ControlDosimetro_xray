...
{
	public partial class FrmInformeISPFilmico : Form
	{
		...
		public FrmInformeISPFilmico(Int64 intId_Cliente)
		{
			InitializeComponent();
		...
		private void Listar_Personal()
		{
			if (!String.IsNullOrWhiteSpace(lbl_id_cliente.Text) || DesdeLimpiar)
			{
				...
				if (cbx_id_seccion.SelectedValue != null && cbx_Sucursal.SelectedValue != null)
					cmd.CommandText = "pa_DosimetroISP_ClienteSeccionFilmico_sel " + cbx_id_periodo.SelectedValue + "," + lbl_id_cliente.Text + "," + cbx_Sucursal.SelectedValue + "," + cbx_id_seccion.SelectedValue + ",'" + lbl_rut_cliente.Text + "'";
				else
				{
					if (DesdeLimpiar)
					{
						cmd.CommandText = "pa_DosimetroISP_ClienteSeccionFilmico_sel 0,0,0,0,'1111'";
					}
					else
						cmd.CommandText = "pa_DosimetroISP_ClienteSeccionFilmico_sel " + cbx_id_periodo.SelectedValue + "," + lbl_id_cliente.Text + ",0,0,'" + lbl_rut_cliente.Text + "'";
				}
		...
		//	};
		//	DataSet dt;
		//	dt = Conectar.Listar(ClaseGeneral.Conexion, cmdSucursal);
